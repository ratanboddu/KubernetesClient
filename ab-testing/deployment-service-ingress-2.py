...
container = client.V1Container(
    name="canary",
    image="registry.lti-aiq.in:443/mosaic-ai-logistics/mosaic-ai-templates-ga:Canary-Dep-2",
    image_pull_policy="Never",
    env=[client.V1EnvVar(name="VERSION", value="v2.0.0")]

)

# Template
template = client.V1PodTemplateSpec(
    metadata=client.V1ObjectMeta(labels={"app": "canary", "version": "v2.0.0"}),
    spec=client.V1PodSpec(containers=[container]))

# Spec
spec = client.ExtensionsV1beta1DeploymentSpec(
    replicas=1,
    selector=client.V1LabelSelector(match_labels={"app": "canary", "version": "v2.0.0"}),
    template=template)
...
deployment = client.ExtensionsV1beta1Deployment(
    ...
    kind="Deployment",
    metadata=client.V1ObjectMeta(name="dep2", labels={"app": "canary"}),
    spec=spec)
...
body = client.V1Service(
    ...
    metadata=client.V1ObjectMeta(
        name="dep2-service", labels={"app": "canary"}
    ),
    spec=client.V1ServiceSpec(
        selector={"app": "canary", "version": "v2.0.0"},
...
body = client.V1beta1Ingress(
    api_version="extensions/v1beta1",
    kind="Ingress",
    metadata=client.V1ObjectMeta(name="dep2-ingress-canary", labels={"app": "canary"}, annotations={
